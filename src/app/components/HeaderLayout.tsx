...
function HeaderLayout() {
  ...
  return (
    <header className="absolute inset-x-0 top-0 z-50 lg:px-60 md:px-28 sm:px-10">
      <nav
        aria-label="Global"
      ...
      >
        <div className="flex lg:flex-1 text-white">
          <Link
            href="/"
            className="text-2xl font-extralight leading-6 text-white"
          >
            URUZ
          </Link>
        </div>
        <div className="flex lg:hidden">
          <button
            ...
            className="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-white0"
          >
        ...
        <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-slate-800 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
          <div className="flex items-center justify-between">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">URUZ</span>
              <Image alt="" src="" className="h-8 w-auto" />
            </a>
            <button
              type="button"
